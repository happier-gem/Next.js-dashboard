              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="min-w-0">
                    <p className="truncate text-sm font-semibold dark:text-gray-100 md:text-base">
                      {invoice.name}
                    </p>
                ...
                <p
                  className={`${lusitana.className} truncate text-sm font-medium dark:text-gray-100 md:text-base`}
                >
                  {invoice.amount}
                </p>
              </div>
